...
export const ClaimDetailScreen = ({ claim, onBack }: ClaimDetailProps) => {
  ...
  const { messages, isLoading, loadMore } = useMessages(claim.id);
    ...
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      >
        <FlatList
          ...
          inverted={true} // El array comenzará abajo del todo y subirá de forma natural.
          onEndReached={loadMore} // Carga más mensajes viejos al hacer scroll hacia ARRIBA.
          onEndReachedThreshold={0.2}
        />

        {/* El contenedor del input permanece intacto en la parte inferior */}
        <View style={styles.inputContainer}>
          <TextInput
            ...
            multiline
            maxLength={500}
            editable={false} // Deshabilitado temporalmente como solicitaste
          />
          <TouchableOpacity
